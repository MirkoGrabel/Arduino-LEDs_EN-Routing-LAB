...
const byte MAX_LEDS = 6;                             // Max LEDs in any strip

// Create objects to drive LEDs. First parameter is the maximum LEDs, second is the digital PIN they ar econnected to
Adafruit_NeoPixel A01L = Adafruit_NeoPixel(6, 0, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A01R = Adafruit_NeoPixel(6, 1, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A02L = Adafruit_NeoPixel(6, 2, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A02R = Adafruit_NeoPixel(6, 3, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A03L = Adafruit_NeoPixel(6, 4, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A03R = Adafruit_NeoPixel(6, 5, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A04L = Adafruit_NeoPixel(6, 6, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A04R = Adafruit_NeoPixel(6, 7, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A05L = Adafruit_NeoPixel(6, 8, NEO_RGBW + NEO_KHZ800);
Adafruit_NeoPixel A05R = Adafruit_NeoPixel(6, 9, NEO_RGBW + NEO_KHZ800);
...
byte wait = 5;                                      // Standard wait delay used throughout demos 
...
{
  for(byte GREEN=0; GREEN<255; GREEN++)                          // For loop cycles through the color brightness
  {
      SET_ALL_COLORS(GREEN,0,0,0);
      delay(wait);                        // Delay for visual effect
  }
  
  for(byte RED=0; RED<255; RED++) 
  {
      SET_ALL_COLORS(0,RED,0,0);
      delay(wait); 
  }
  for(byte BLUE=0; BLUE<255; BLUE++) 
  {
      SET_ALL_COLORS(0,0,BLUE,0);
      delay(wait);
  }
  for(byte WHITE=0; WHITE<255; WHITE++) 
  {
      SET_ALL_COLORS(0,0,0,WHITE);
      delay(wait);
  }
}
...
void TERMINAL_SERVERS()
{
   ...
   {
    A01L.setPixelColor(MAX_LEDS-2, A01L.Color(0, 255, 0, 0));
    A01L.setPixelColor(MAX_LEDS-3, A01L.Color(0, 255, 0, 0));
    A01R.setPixelColor(MAX_LEDS-2, A01R.Color(0, 255, 0, 0));
    A01R.setPixelColor(MAX_LEDS-3, A01R.Color(0, 255, 0, 0));
    A02L.setPixelColor(MAX_LEDS-2, A02L.Color(0, 255, 0, 0));
    A02L.setPixelColor(MAX_LEDS-3, A02L.Color(0, 255, 0, 0));
    A02R.setPixelColor(MAX_LEDS-2, A02R.Color(0, 255, 0, 0));
    A02R.setPixelColor(MAX_LEDS-3, A02R.Color(0, 255, 0, 0));
    A03L.setPixelColor(MAX_LEDS-2, A03L.Color(0, 255, 0, 0));
    A03L.setPixelColor(MAX_LEDS-3, A03L.Color(0, 255, 0, 0));
    A03R.setPixelColor(MAX_LEDS-2, A03R.Color(0, 255, 0, 0));
    A03R.setPixelColor(MAX_LEDS-3, A03R.Color(0, 255, 0, 0));
    A04L.setPixelColor(MAX_LEDS-2, A04L.Color(0, 255, 0, 0));
    A04L.setPixelColor(MAX_LEDS-3, A04L.Color(0, 255, 0, 0));
    A04R.setPixelColor(MAX_LEDS-2, A04R.Color(0, 255, 0, 0));
    A04R.setPixelColor(MAX_LEDS-3, A04R.Color(0, 255, 0, 0));
    A05L.setPixelColor(MAX_LEDS-2, A05L.Color(0, 255, 0, 0));
    A05L.setPixelColor(MAX_LEDS-3, A05L.Color(0, 255, 0, 0));
    A05R.setPixelColor(MAX_LEDS-2, A05R.Color(0, 255, 0, 0));
    A05R.setPixelColor(MAX_LEDS-3, A05R.Color(0, 255, 0, 0));   

    SHOW_ALL_LEDS();                   // Show terminal server LEDs in red
    
    delay(500);                       // Wait
    A01L.setPixelColor(MAX_LEDS-2, A01L.Color(255, 0, 0, 0));
    A01L.setPixelColor(MAX_LEDS-3, A01L.Color(255, 0, 0, 0));
    A01R.setPixelColor(MAX_LEDS-2, A01R.Color(255, 0, 0, 0));
    A01R.setPixelColor(MAX_LEDS-3, A01R.Color(255, 0, 0, 0));
    A02L.setPixelColor(MAX_LEDS-2, A02L.Color(255, 0, 0, 0));
    A02L.setPixelColor(MAX_LEDS-3, A02L.Color(255, 0, 0, 0));
    A02R.setPixelColor(MAX_LEDS-2, A02R.Color(255, 0, 0, 0));
    A02R.setPixelColor(MAX_LEDS-3, A02R.Color(255, 0, 0, 0));
    A03L.setPixelColor(MAX_LEDS-2, A03L.Color(255, 0, 0, 0));
    A03L.setPixelColor(MAX_LEDS-3, A03L.Color(255, 0, 0, 0));
    A03R.setPixelColor(MAX_LEDS-2, A03R.Color(255, 0, 0, 0));
    A03R.setPixelColor(MAX_LEDS-3, A03R.Color(255, 0, 0, 0));
    A04L.setPixelColor(MAX_LEDS-2, A04L.Color(255, 0, 0, 0));
    A04L.setPixelColor(MAX_LEDS-3, A04L.Color(255, 0, 0, 0));
    A04R.setPixelColor(MAX_LEDS-2, A04R.Color(255, 0, 0, 0));
    A04R.setPixelColor(MAX_LEDS-3, A04R.Color(255, 0, 0, 0));
    A05L.setPixelColor(MAX_LEDS-2, A05L.Color(255, 0, 0, 0));
    A05L.setPixelColor(MAX_LEDS-3, A05L.Color(255, 0, 0, 0));
    A05R.setPixelColor(MAX_LEDS-2, A05R.Color(255, 0, 0, 0));
    A05R.setPixelColor(MAX_LEDS-3, A05R.Color(255, 0, 0, 0));
...
*/
  ...
  // RUN UP 1
  for(byte INCREASE=0; INCREASE<255; INCREASE++)
  {
    A01L_RED = INCREASE;
    RAINBOW_SHOW_COLORS();
    delay(RAINBOW_WAIT);
