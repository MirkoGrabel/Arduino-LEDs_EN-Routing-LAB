...
#define THING_NAME "Arduino_Uno_1"

char mqttServer[]           = "a3575go64bfs8h.iot.us-west-2.amazonaws.com";
char clientId[]             = "Arduino_Uno_1";
...
void updateLedState(int desired_led_state) {
  Serial.print("change led_state to something");
  ...
  Serial.print("Publish something somewhere");
