...
const int A01L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A01R_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A02L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A02R_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A03L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A03R_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A04L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A04R_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A05L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A05R_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A06L_LEDS = 90;                           // Amount of LEDs in LED Strip
const int A06R_LEDS = 90;                           // Amount of LEDs in LED Strip

const int MAX_LEDS = 112;                             // Max LEDs in any strip
